...
class Pipeline_Upload():
	...
	def baseinfo_search(self):
		#查询数据库获取基本信息
		print("Acquiring Base Information")
		...
		self.usremail = self.baseinfo.myconfig.get("customerEmail", 'test')
		#使用hashlib加密 使字符串格式标准化
		self.usrmd5()
	...
	def usrmd5(self):
		mb = hashlib.md5()
		#sb = hashlib.sha1()
		mb.update(self.usremail.encode('utf8'))
		#sb.update(self.usremail.encode('utf8'))
		self.usr = mb.hexdigest().title()
