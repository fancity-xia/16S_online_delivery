...
def main(argv=None):
	...
	parser.add_argument('--cpdir','-c', required=False, help='cpdir', default="")
	...
	if not os.path.lexists(analsysispath + "/Cleandata"):
		upload_cleandata_to_file.Run_cp_upload(analsysispath , Pure_16S_Pipeline['method'], Pure_16S_Pipeline['upload_CleanData_output_file'], cpdir)
	handle_upload = PureFilter_upload(analysisid, cpdir)
